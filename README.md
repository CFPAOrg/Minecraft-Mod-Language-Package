...
感谢玩家`3TUSK`，`Snownee`，`Sihenzhang`，`CNife`，`DLslime`，`DSLM`，`gloomy_banana`，`yuanjie000`，`loveyanbei`，`ZhuKaihui`，`Uptobillion`，`TehporP`，`forestbat`，`MaxBellc`，`Dobby233Liu`，`HigZxcvd`，`bxz2311196368`，`waitLH`提供的汉化。（排名不分先后）  
                
感谢`PeakXing`制作的logo。
