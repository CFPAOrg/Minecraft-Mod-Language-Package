...
//                                Directory.CreateDirectory($"./projects/assets/{info.ProjectName}/{domain}/{version}/lang/");
//                                if (File.Exists($"./projects/assets/{info.ProjectName}/{domain}/{version}/lang/{zipArchiveEntry.Name.ToLower()}")) {
//                                    File.Delete($"./projects/assets/{info.ProjectName}/{domain}/{version}/lang/{zipArchiveEntry.Name.ToLower()}");
//                                }
//                                Log.Logger.Information($"解压：{zipArchiveEntry.FullName}");
//                                zipArchiveEntry.ExtractToFile($"./projects/assets/{info.ProjectName}/{domain}/{version}/lang/{zipArchiveEntry.Name.ToLower()}");
//                            }
//                        }
//                    }
//                }
