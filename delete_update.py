...
print("del_update Script Loading")

import operator

# 读取文件
old = open("zh_cn_old.lang", 'r', encoding='UTF-8')
new = open("zh_cn.lang", 'r', encoding='UTF-8')
out = open("zh_cn_out.lang", 'w', encoding='UTF-8')
...
print("del_update Script Stop Load")
